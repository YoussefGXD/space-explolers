...
songs = [
  {
    author: "Daughter",
    song: "Youth",
    audio: "https://jewel998.github.io/playlist/music/Daughter-Youth.mp3",
  },
  {
    author: "Novo Amor",
    song: "State Lines",
    audio: "https://jewel998.github.io/playlist/music/NovoAmor-StateLines.mp3",
  },
  {
    author: "Lewis Capaldi",
    song: "Someone You Loved",
    audio:
      "https://jewel998.github.io/playlist/music/LewisCapaldi-SomeoneYouLoved.mp3",
  },
  {
    author: "Yutaka Yamada",
    song: "Remembering",
    audio:
      "https://jewel998.github.io/playlist/music/YutakaYamada-Remembering.mp3",
  },
  {
    author: "David Choi",
    song: "By My Side",
    audio: "https://jewel998.github.io/playlist/music/DavidChoi-ByMySide.mp3",
  },
  {
    author: "Marshmello ft. Bastille",
    song: "Happier",
    audio:
      "https://jewel998.github.io/playlist/music/Marshmelloft.Bastille-Happier.mp3",
  },
  {
    song: "Up Up & Away",
    author: "Chance Peña",
    audio: "https://jewel998.github.io/playlist/music/ChancePena-UpUp&Away.mp3",
  },
  {
    author: "HONNE",
    song: "Me & You",
    audio: "https://jewel998.github.io/playlist/music/HONNE-Me&You.mp3",
  },
  {
    song: "Don't Let Me Fall",
    author: "Lenka",
    audio: "https://jewel998.github.io/playlist/music/Lenka-DontLetMeFall.mp3",
  },
  {
    author: "Explosions In The Sky",
    song: "Your Hand In Mine",
    audio:
      "https://jewel998.github.io/playlist/music/ExplosionsInTheSky-YourHandInMine.mp3",
  },
  {
    author: "Birdy",
    song: "The District Sleeps Alone Tonight",
    audio:
      "https://jewel998.github.io/playlist/music/Birdy-TheDistrictSleepsAloneTonight.mp3",
  },
  {
    song: "Shallows",
    author: "Daughter",
    audio: "https://jewel998.github.io/playlist/music/Daughter-Shallows.mp3",
  },
];
...
$(document).ready(function () {
  $.getJSON("text.json", function (data) {
    ...
    function addToPlayList(data, index) {
      ...
      html = $("#show-list").html();
      html +=
        '<div class="float-song-card" data-index="' +
        index +
  ...
  $("#search").keyup(function () {
    ...
    $(".float-song-card:contains(" + toSearch + ")").css(
      "display",
      "inline-block"
    );
  });
